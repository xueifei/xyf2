...
<div class="wrapper">
    ...
    <!-- 导航侧栏 -->
    <jsp:include page="aside0.jsp"></jsp:include>
    <!-- 导航侧栏 /-->
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="${pageContext.request.contextPath}/admin/listUser">用户管理</a></li>
                        ...
                        <c:forEach items="${user.roles}" var="role" varStatus="vs1">
                            ...
                            <c:forEach items="${role.permissions}" var="permission" varStatus="vs2">
                                <c:if test="${empty permission.children}">
                                    ...
                                    <c:forEach items="${permission.children}" var="ch" varStatus="vs3">
                                        <tr data-tt-id="${vs2.index+1}-${vs3.index+1}"
                                            data-tt-parent-id="${vs2.index+1}">
                                            <td>${ch.name}</td>
                                            <td>${ch.url}</td>
                                        </tr>
                                    </c:forEach>

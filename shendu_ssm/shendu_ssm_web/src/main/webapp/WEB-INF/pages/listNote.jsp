				...
				<div class="box box-primary">
					...
					<div class="box-body">
						...
						<div class="table-box">
                            ...
                            <form action="${pageContext.request.contextPath}/note/fuzzyNote"method="post">
                                <div class="box-tools pull-right">
                                    <div class="input-group input-group-sm" style="width: 150px;">
                                        <input type="text" name="name" class="form-control pull-right" placeholder="根据姓名、状态查询、信息模板">
